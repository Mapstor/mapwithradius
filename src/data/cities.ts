    ...
    coverage: [
      ...
      },
      {
        ...
        includes: [
          ...
          'Zaandam (~9 km north — just inside)',
        ],
        excludes: [
          'Schiphol Airport (~12 km southwest)',
  ...
  },
  {
    ...
    coverage: [
      ...
      },
      {
        ...
        label: '50 km',
        description:
          'A 50 km radius covers Munich Airport, Augsburg\'s eastern edge, Rosenheim\'s western edge, and most of the Bavarian commuter belt. Ingolstadt sits well past the northern edge.',
        includes: [
          'Munich Airport (MUC)',
